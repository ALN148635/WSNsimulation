...
def draw_graph_3_3(density, side_width, side_height, sim_time, g_r,
               v_x, v_y, r_x, r_y, r_t):
    lines = []
    # 得到随机节点的坐标
    ...
    inf_sim = []
    for _ in range(5):
        my_sim = my_model_sim(open=0.2, spr=0.2,
    ...
    inf_sim = []
    for _ in range(5):
        my_sim = my_model_sim(open=0.3, spr=0.3,
                              eta_low=1, eta_high=1,
                              alpha=0.5,
                              r_t=r_t,
                              beta=1, rho=1,
    ...
    inf_sim = []
    for _ in range(5):
        my_sim = my_model_sim(open=0.4, spr=0.4,
                              eta_low=1, eta_high=1,
                              alpha=0.5,
                              r_t=r_t,
                              beta=1, rho=1,
    ...
    inf_sim = []
    for _ in range(5):
        my_sim = my_model_sim(open=0.6, spr=0.6,
                              eta_low=1, eta_high=1,
                              alpha=0.5,
                              r_t=r_t,
                              beta=1, rho=1,
    ...
    inf_sim = []
    for _ in range(5):
        my_sim = my_model_sim(open=0.7, spr=0.7,
                              eta_low=1, eta_high=1,
                              alpha=0.5,
                              r_t=r_t,
                              beta=1, rho=1,
